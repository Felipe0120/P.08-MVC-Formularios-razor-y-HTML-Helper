...
namespace DawActivy.Controllers
{
    public class estados_equipoController : Controller
    {
        ...
        public estados_equipoController(equipoDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.estados_equipos != null ? 
                          ...
                          Problem("Entity set 'equipoDbContext.estados_equipos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'equipoDbContext.estados_equipos'  is null.");
            }
            var estados_equipo = await _context.estados_equipos.FindAsync(id);
            if (estados_equipo != null)
            {
