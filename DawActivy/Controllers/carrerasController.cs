...
namespace DawActivy.Controllers
{
    public class carrerasController : Controller
    {
        ...
        public carrerasController(equipoDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.carreras != null ? 
                          ...
                          Problem("Entity set 'equipoDbContext.carreras'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'equipoDbContext.carreras'  is null.");
            }
            var carreras = await _context.carreras.FindAsync(id);
            if (carreras != null)
            {
