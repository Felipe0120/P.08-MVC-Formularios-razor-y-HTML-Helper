...
namespace DawActivy.Controllers
{
    public class estados_reservaController : Controller
    {
        ...
        public estados_reservaController(equipoDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.estados_reserva != null ? 
                          ...
                          Problem("Entity set 'equipoDbContext.estados_reserva'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'equipoDbContext.estados_reserva'  is null.");
            }
            var estados_reserva = await _context.estados_reserva.FindAsync(id);
            if (estados_reserva != null)
            {
