...
namespace DawActivy.Controllers
{
    public class facultadesController : Controller
    {
        ...
        public facultadesController(equipoDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.facultades != null ? 
                          ...
                          Problem("Entity set 'equipoDbContext.facultades'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'equipoDbContext.facultades'  is null.");
            }
            var facultades = await _context.facultades.FindAsync(id);
            if (facultades != null)
            {
