...
namespace DawActivy.Controllers
{
    public class marcasController : Controller
    {
        ...
        public marcasController(equipoDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.marcas != null ? 
                          ...
                          Problem("Entity set 'equipoDbContext.marcas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'equipoDbContext.marcas'  is null.");
            }
            var marcas = await _context.marcas.FindAsync(id);
            if (marcas != null)
            {
